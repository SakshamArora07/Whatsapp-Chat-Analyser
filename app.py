...
uploaded_file = st.sidebar.file_uploader("Choose a file") # file uploader widget in sidebar
if uploaded_file is not None:
    # To read file as bytes:
    bytes_data = uploaded_file.getvalue() # getvalue() retrieves the content of the file as bytes.
    # st.write(bytes_data)
    # converting the bytes data into a string
    data = bytes_data.decode("utf-8") # The bytes are decoded into a string using UTF-8 encoding.
    # st.text(data)
